...
<body>
    ...
    <?php
        ...
        $poster="SELECT kodePend, kategori, namaTim, karya, deskirpsi, nilai FROM pendaftaran WHERE kategori = 'poster'";
        $resultP = mysqli_query($koneksi, $poster);
      ?>
      <div class="container"><br><br><br>
      <center>
          <h1><b>Beri Penilaian</b></h1>
      </center>
      <div class="table-responsive">
        <table class="table table-bordered table-sm">
          ...
          <tbody>
              ...
              <td><?=$row['nilai']; ?></td>
              <td>
                <a href="nilaiPage.php?id=<?=$row['kodePend']?>"><button type="button" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">

  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="productdash.php">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="hstack gap-3">
          <div class="card" style="width: 18rem;">
            <img src="../img/Peserta.jpg" class="card-img-top" alt="posterdesign" height="200px" width="auto">
            <div class="card-body">
              <h5 class="card-title" style="color: #303030;">Peserta</h5>
              <a href="pesertaDash.php" class="btn btn-primary">Buka</a>
            </div>
          </div>
          <div class="card" style="width: 18rem;">
            <img src="../img/juri.jpg" class="card-img-top" alt="posterdesign" height="200px" width="auto">
            <div class="card-body">
              <h5 class="card-title" style="color: #303030;">Juri</h5>
              <a href="juriDash.php" class="btn btn-primary">Buka</a>
            </div>
          </div>
        </div>
    </main>

...
<head>
    ...
    <title>TCC UI/UX Competition</title>
</head>
<body>
    <!-- navbar -->
    ...
    <h1 class="judul justify-content-center">TCC UI/UX COMPETITION</h1>
    ...
    <div class="container">
        ...
        <form action="actionUI.php" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col">
